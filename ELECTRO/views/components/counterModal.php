        ...
        <div class="modal-content">            
            ...
            <form class="mt-4" action="./counter/addData" method="post" enctype="multipart/form-data">    
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Закрыть</button>
                    <?php
                        if((date('d')<12 && $_SESSION['user']['group'] != 2) || $_SESSION['user']['group'] == 2) {
                            ?>
                                <button type="submit" class="btn btn-success">Сохранить</button>
                            <?php
                        }
        ...
        <div class="modal-content">            
            ...
            <form class="mt-4" action="./counter/addArendaData" method="post" enctype="multipart/form-data">    
                <div class="modal-body">
                    ...
                    <label class="mb-2" for="value">Показания по счет-фактуре</label>
                    <input type="text" class="form-control" id="valueArenda" name="value" require>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Закрыть</button>                    
                    <?php
                        if((date('d')<16 && $_SESSION['user']['group'] != 2) || $_SESSION['user']['group'] == 2) {                            
                            ?>
                                <button type="submit" class="btn btn-success">Сохранить</button>
                            <?php
                        }
