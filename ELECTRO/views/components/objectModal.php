        ...
        <div class="modal-content">            
            ...
            <form class="mt-4" action="./object/update" method="post" enctype="multipart/form-data">    
                <div class="modal-body">
                    ...
                    <input type="text" class="form-control object_name" name="object_name" id="object_name">
...
<!-- Modal привзяка к аренде -->
<div class="modal fade" id="addArenda" tabindex="-1" aria-labelledby="addArendaTitle" style="display: none;" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">            
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="addArendaTitle"></h1>
            </div>
            <form class="mt-4" action="./object/arenda" method="post" enctype="multipart/form-data">    
                <div class="modal-body">
                    <input type="hidden" class="id_object" name="id_object" id="id_object">
                    
                    <h5 class="mb-4">Привязка объекта к договору аренды</h5>

                    <label for="id_contract" class="form-label">Владелец &#10144 Адрес помещения</label>
                    <select name="id_contract" id="id_contract" class="form-select">
                        <?php
                            $datas = \R::getAll("SELECT `id_contract`, `landlord`, `equip_address` FROM `contracts` ORDER BY `landlord`");
                            foreach($datas as $key => $data) {
                                ?>
                                    <option class="form-control" value="<?=$data['id_contract']?>"><?= $data['landlord'] . " &#10144 " . $data['equip_address']?></option>
                                <?php
                            }
                        ?>
                    </select>
...
<script type="text/javascript">
    ...
    if (updateObject) {
        ...
        const timer = button.getAttribute('data-bs-time');
        ...
        const objectNameInput = updateObject.querySelector('.object_name');
        ...
        objectMount.value = mount;
        objectUsed.value = used;
        objectPower.value = power;
        objectTimer.value = timer;
