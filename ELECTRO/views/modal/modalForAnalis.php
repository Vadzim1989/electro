                ...
                <div class="modal-body">
                    ...
                    <div>
                        ...
                        <select name="sort" id="sort"  class="form-control">
                            ...
                            <option value="u">По уд.потреблению &#8593</option>                             
                            <option value="ud">По уд.потреблению &#8595</option>                            
                        </select>
                    </div> 
                </div>
...
<!-- Modal фильтр -->
<div class="modal fade" id="filterAnalizWarm" tabindex="-1" aria-labelledby="filterTitle" style="display: none;" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">            
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="filterTitle">Удельное потребление эл.энергии</h1>
