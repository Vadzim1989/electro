        ...
        <div class="modal-content">            
            ...
            <form class="mt-4" action="./device/update" method="post" enctype="multipart/form-data">    
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="time">Время работы (Пример: от 0c до ...)</label>
        ...
        <div class="modal-content">            
            ...
            <form class="mt-4" action="/device/add" method="post" enctype="multipart/form-data">    
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="name">Наименование (Пример: Компьютер)</label>
                        <input type="text" class="form-control" id="name" name="name" required>
                    </div>

                    <div class="mb-3">
                        <label for="mount">Установлено (Пример: от 0 до ...)</label>
                        <input type="text" class="form-control" id="mount" name="mount" required>
                    </div>

                    <div class="mb-3">
                        <label for="used">Используется (Пример: от 0 до ...)</label>
                        <input type="text" class="form-control" id="used" name="used" required>
                    </div>

                    <div class="mb-3">
                        <label for="power">Потребляемая мощность, Вт (Пример: от 0 до ...)</label>
                        <input type="text" class="form-control" id="power" name="power" required>
                    </div>
...
<!-- Обработка кнопки вызова модального окна ОБОРУДОВАНИЯ -->
<script type="text/javascript">
    ...
    if (updateDevice) {
        ...
        const remark = button.getAttribute('dev-r');
        ...
        const deviceRemark = updateDevice.querySelector('#remark');
        ...
        deviceRemark.textContent = remark;
    })
    };
